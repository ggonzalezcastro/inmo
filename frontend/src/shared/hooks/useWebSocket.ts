...
export type WSEventType =
  ...
  | 'meta_ad_campaign_submitted'
  | 'meta_ad_campaign_approved'
  | 'meta_ad_campaign_rejected'
  | 'meta_ad_campaign_published'
  | 'meta_ad_campaign_activated'
  | 'meta_ad_campaign_paused'
