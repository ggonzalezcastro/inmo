...
Sé profesional pero amigable."""
        ...
        try:
            response = await LLMService.generate_response(greeting_prompt)
...
- stage_to_move: etapa a la que mover el lead (o null)"""
        ...
        try:
            # Use LLM to process
            response = await LLMService.generate_response(processing_prompt)
...
- stage_to_move: etapa a la que avanzar (o null)"""
        ...
        try:
            response = await LLMService.generate_response(summary_prompt)
