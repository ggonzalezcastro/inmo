#!/usr/bin/env python
"""
Seed script para Railway — crea 3 inmobiliarias con usuarios
Ejecutar: python seed_railway.py
"""
import asyncio
import sys
...
DATABASE_URL = "postgresql://postgres:SQunzsbimTiRZHfHzIAGdCAFbEcdkLOG@inmo-db.railway.internal:5432/railway"
...
def hash_password(password: str) -> str:
    """Simple hash for testing (bcrypt equivalent)"""
